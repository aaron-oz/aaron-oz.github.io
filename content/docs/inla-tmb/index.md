...
You can access a repo with code from this project on my github, [here](https://github.com/aaron-oz/tmb-inla-paper).

For now, here's a few brief snippets from the paper to get anyone interested up and running.

* [Setup and Simulation]({{< relref "inla-tmb#prep" >}} "")

* [Fitting GP using R-INLA]({{< relref "inla-tmb#inla" >}} "")

* [Fitting GP using TMB]({{< relref "inla-tmb#tmb" >}} "")

* [Comparing estimates from TMB and INLA]({{< relref "inla-tmb#comp" >}} "")



## Simulating data and generating SPDE objects for INLA and TMB {id="prep"}
...
{{< figure title="Prep Plots" caption="Above you see the simulated truth, the simulated data, and the triangulation used for the finite elements SPDE approximation." src="./img/example_code_prep.png" >}}



## Continuous GP modeling with SPDE in R-INLA {id="inla"}
...
{{< figure title="INLA Fit" caption="Above you see the truth, data sampling locations, the predictions (posterior median) from R-INLA, the associated standard deviation of the predictions and areas where 90% credible intervals missed the truth." src="./img/example_inla.png" >}}

## Continuous GP modeling with SPDE in TMB {id="tmb"}

```R
## define the TMB model using c++ template code
##  this is usually done in a separate file,
##  but it can be done all from within 1 R script
...
{{< figure title="TMB Fit" caption="Above you see the truth, data sampling locations, the predictions (posterior median) from TMB, the associated standard deviation of the predictions and areas where 90% credible intervals missed the truth." src="./img/example_tmb.png" >}}

## INLA and TMB Comparison {id="comp"}

{{< figure title="TMB and INLA Comparison" caption="Above you see the comparisons between the predictions and standard deviation of the estimated field from both TMB and INLA fits." src="./img/example_tmb_v_inla.png" >}}